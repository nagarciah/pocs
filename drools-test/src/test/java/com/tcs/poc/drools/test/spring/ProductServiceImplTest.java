package com.tcs.poc.drools.test.spring;
...
import com.tcs.poc.drools.spring.model.CountryType;
import com.tcs.poc.drools.spring.model.DecisionType;
import com.tcs.poc.drools.spring.model.Product;
import com.tcs.poc.drools.spring.model.ProductType;
...
@ContextConfiguration("classpath:config/spring/main-context.xml")
