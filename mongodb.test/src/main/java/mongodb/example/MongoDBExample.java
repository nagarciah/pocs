...
public class MongoDBExample {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        System.out.println("result.getUpsertedId()=" + result.getUpsertedId());
        System.out.println("result.getN()=" + result.getN());
        System.out.println("result.isUpdateOfExisting()=" + result.isUpdateOfExisting());
        ...
        while(cursor.hasNext()){
            System.out.println("Document found: " + cursor.next());
        }
